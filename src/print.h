...
void print_file_matches(const char *path, const char *buf, const size_t buf_len,
...
void print_results_as_matched_line(struct _results_t *self, size_t line_number,
                         struct _line_t *line);
